...
<body class="bg-gray-100">
    ...
    <div class="flex min-h-screen">
        ...
        {{-- SIDEBAR --}}
        <aside id="sidebar" class="sidebar-expanded bg-white shadow-xl border-r transition-all duration-300 flex flex-col fixed lg:static inset-y-0 left-0 z-50 lg:z-auto lg:translate-x-0 -translate-x-full">
            ...
            <nav class="flex-1 overflow-y-auto">
                <ul class="px-3 py-4 space-y-2">
                    ...
                    <li>
                        <a href="{{ route('dashboard') }}" class="flex items-center gap-4 px-4 py-2 rounded-lg hover:bg-gray-100 group">
                    ...
                    <li>
                        <a href="{{ route('accounts.index') }}" class="flex items-center gap-4 px-4 py-2 rounded-lg hover:bg-gray-100 group">
                    ...
                    <li>
                        <a href="{{ route('journal.index') }}" class="flex items-center gap-4 px-4 py-2 rounded-lg hover:bg-gray-100 group">
                            <i data-lucide="file-text"></i>
                            <span class="sidebar-text font-medium">Journal Entries</span>
                        </a>
                    </li>

                    <li>
                        <a href="#" class="flex items-center gap-4 px-4 py-2 rounded-lg hover:bg-gray-100 group">
                            <i data-lucide="package"></i>
